...
Llet's turn to something more high-minded: the
...
fluid has to shear as it moves around the object, [*viscosity*](https://en.wikipedia.org/wiki/Viscosity) quantifies the
