...
Stars fuse hydrogen, and the pressure generated by these thermonuclear
reactions stop the star from contracting under its own weight.
But once a star runs out of fuel, it will start to collapse.
Different things can happen, depending on the mass $M$ of the star
before collapse:
- *Black holes*. If the star is heavier than $30$ suns, $M > 30
  M_\odot$, nothing can arrest the collapse, and the star forms a
  black hole.
- *White dwarfs*. When stars less than $10$ suns heavy ($M < 10
  M_\odot$) run out of nuclear
