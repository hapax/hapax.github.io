...
This group is generated by adding $1$, or $S: |k\rangle \mapsto
|k+1\rangle$, modulo $d$, where $S$ stands for "successor" or "shift".
This corresponds to a *matrix* on the Hilbert space $\mathcal{H}_d$:
