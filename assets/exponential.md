...
some interest $r I_0$, so the total value of the investment is $I_\text{simple} = (1+r)I_0$.
...
$$
I_{\text{compound}(2)} = \left(1 + \frac{r}{2}\right) I_1 = \left(1 + \frac{r}{2}\right)^2 I_0.
$$

For a positive interest rate, $I_1 > I_0$, so you will get more
interest in the compound scheme.
Mathematically, $I_{\text{compound}(2)} > I_\text{simple}$ because
