...
**February 19, 2021.** *A self-contained derivation of the most famous
  ...
  to conservation laws, and end by considering the relativistic mechanics of an exploding bowling ball.*
...
4. <a href="#sec-4">Factorising spacetime</a>
4. <a href="#sec-5">Velocity addition</a>
5. <a href="#sec-6">Conservation laws</a>
6. <a href="#sec-7">Mass effect</a>
7. <a href="#sec-8">The most famous equation</a>
8. <a href="#sec-9">Exercises</a>
...
A few preliminary comments. First, the exercise section is optional,
...
I hope my mildly eccentric approach can be of benefit to others.
...
We describe relative orientation more explicitly in <a
href="#sec-9">Exercise 1</a>.
...
See <a href="#sec-9">Exercise 4</a> for a discussion of what happens if we *only* ask for
invariance of $s^2 = 0$.
...
moving rulers called *length contraction*.
...
Note that from (\ref{gamma}), a moving clock appears to stop at $v =
c$.
Put differently, no time passes for a light ray!

#### 4. Factorising spacetime <a id="sec-4" name="sec-4"></a>
...
So $e^\eta$ obeys = \frac{\Delta x' + c\Delta t'}{\Delta x' - c\Delta t'}\cdot \frac{ -c\Delta\tau}{+c\Delta\tau} -->
...
From this equation, we can deduce the rule for transforming quantities
...
#### 5. Velocity addition <a id="sec-5" name="sec-5"></a>

We can use equation (\ref{alpha}) to chain together multiple changes of frame.
...
I'll let you check the algebra in <a href="#sec-9">Exercise 5</a>.

#### 6. Conservation laws<a id="sec-6" name="sec-6"></a>
...
change. In fact, if the total force on a *collection* of bowling balls is zero, the
...
#### 7. Mass effect<a id="sec-7" name="sec-7"></a>
...
conserved in <a href="#sec-9">Exercise 7</a>.

#### 8. The most famous equation<a id="sec-8" name="sec-8"></a>
...
Remember that $M_0$ is fixed. As $u$ increases, the second term on the RHS
...
This relation even tells us something about massless particles, as we explore in
...
Hopefully you now have a sense of why Einstein's famous formula is true.

#### 9. Exercises<a id="sec-9" name="sec-9"></a>
