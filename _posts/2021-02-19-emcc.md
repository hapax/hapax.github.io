...
about how to present special relativity, guiding in particular my choice to restrict
...
See <a href="#sec-8">Exercise 5</a> for a discussion of what happens if we *only* ask for
invariance of $s^2 = 0$.
...
The details are worked out in <a href="#sec-8">Exercise 3</a>.
In <a href="#sec-8">Exercise 4</a>, we also determine the more general class of transformations which
...
I'll let you do the algebra in <a href="#sec-8">Exercise 5</a>.
...
You can check in <a href="#sec-8">Exercise 6</a> that this problem persists in other
reference frames.
...
conserved in <a href="#sec-8">Exercise 7</a>.
...
#### 8. Exercises<a id="sec-8" name="sec-8"></a>
