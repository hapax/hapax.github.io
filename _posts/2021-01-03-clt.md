...
This vanishing of diagonal sums is similar (but not exactly the same)
to the *Lyapunov condition*, so I suspect this is a very heuristic
version of what is called the Lyapunov CLT, after the Russian
mathematician and physicist [Aleksandr Lyapunov](https://en.wikipedia.org/wiki/Aleksandr_Lyapunov).
We will therefore refer to the vanishing of these diagonal sums as a
...
which satisfy the Lyapunov-like condition.
