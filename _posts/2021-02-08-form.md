...
Instead, I will approach the notion of pattern by picking on two
smaller problems, with Newton's laws as a concrete example.
...
Patterns are large and rhizomatic, and human formalism, the
mathematical glance, can only take in part of them.
...
a tropical jungle.
And a formalism typically cannot see the forest for the trees.
<!-- 
...
in mathematics (in, e.g., real analysis, topology, and statistics)
and physics (perturbation theory and renormalisation).
These make structural approximations robust, lawlike and explanatory.
This also suggests another metalaw: patterns can stand in patterned
...
Clearly, many questions are not answered by this approach.
What is the relation of a pattern to its equivalence class of
descriptions?
Must patterns be instantiated in the physical world, and if not, where
do such patterns live?
What is the mereology of patterns, e.g. what allows one pattern to be
approximated by or reduce to another?
And finally, what grounds the truth about patterns, in physics,
mathematics, or elsewhere?
I leave the systematic exploration of these questions to a future me,
but in the mean time, welcome discussion and debate!
