...
luck (and the [pigeonhole principle](https://en.wikipedia.org/wiki/Pigeonhole_principle)), we often unknowingly describe the same
...
In the mean time, discussion and debate are welcome!
