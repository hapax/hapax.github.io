...
some sort of extrasensory perception. Clearly, since we are physical
...
unreasonable that the effectiveness of geology for outlining the
...
The interested reader should also check out James Franklin's
[book](https://link.springer.com/book/10.1057/9781137400734) for a
modern take on how Aristotle's ideas apply to mathematics.
...
mechanics, Lagrangian and Hamiltonian, which explain
...
goes by the name of symplectic geometry.
...
Formalisms are perspectives on patterns.
<!-- capture
different patterns, or suggest different extensions, in ways that can
depend sensitively on the formalism and the domain of application. -->

This hints at certain structural "metalaws".
Patterns are large and rhizomatic, and human formalism, a single
mathematical glance if you like, can only take in part of them.
...
parallelogram with diagonals of equal length, but different notions
are implicated in the two characterisations, and connect along
...
It could be that there is a paucity of structure, so we very often are
unknowingly describing the same thing in a different guise.
...
<!-- This is also what emergence is all about! -->

This ties back to our original question, namely the nature of physical
explanation.
Reductionism instructs us to boil things down the smallest elements.
The Aristotelian view is that, really, we should be searching for
form and structure at whatever level they happen to occur.
This is not only the nature of emergence, but really physics itself.
How else can you tie together the study of the large-scale structure
of spacetime, the subatomic realm, and phases of matter?
Physicists don't always or primarily boil things down to small
elements; rather, *physicists study natural patterns*.
That means that, for better or worse, they often wade into other
fields armed with Emergent Patterns to corral the apparent complexity.
See for
instance
...
they are doing what they've been trained to do.
...
only parsimonious but even necessary to commit to the existence of
...
Most of these I defer to Aristotle, though I hope write more
about them in future. <!-- I leave the systematic exploration of these questions to the future,-->
In the mean time, I welcome discussion and debate!
...
technical doodad called renormalisation. This formalises the idea of "zooming out".
</p></div>
