...
The `words` corpus includes ridiculous words like "spoffle" and "pewdom".
...
Both necessitate a scoring system, sacrificing some of the appealing
simplicity of the original version.
