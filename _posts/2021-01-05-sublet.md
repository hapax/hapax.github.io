...
The problem is that the `words` corpus includes ridiculous words like "spoffle" and
"pewdom".
...
This dips a bit more quickly and early than our previous examples, with $a \approx 3.6$ and
$b \approx 3.65$:
...
Nevertheless, the shape of the curve is captured by our simple random model.
