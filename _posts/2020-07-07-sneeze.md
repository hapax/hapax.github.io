...
**July 7, 2020.** *The physics of sneezing and aeorosols is
  fascinating and timely given concerns around physical
  distancing guidelines for COVID. Here, we start by exploring some
  simple models for the ballistic spray of larger droplets, and find
  results in accordance with the WHO guidelines.*
...
**Exercise 3.** (a) Redo the analysis to see how range depends on droplet size $r$.
