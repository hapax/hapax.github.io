...
**July 7, 2020.** *I study some simple models for the ballistic spray
  of larger droplets of a sneeze. Including drag, I get a result
  consistent with the WHO guidelines.*

**DISCLAIMER.** I am not an aerosol physicist, epidemiologist, doctor,
 or allied health practitioner of any sort. These calculations are
 solely for my own (and perhaps others') entertainment. They should
...
use quadratic drag.
Air has density around $1.2 \text{ kg/m}^3$.
...
**Exercise 3.** (a) Redo the analysis to see how range depends on
droplet size $r$.
You should find a range

$$
R = \frac{m}{\pi \rho r^2} \left[2\log\left(\frac{2 \rho r v_0}{\eta}\right) + \frac{1}{12}\right].
$$

(b) (*For the author.*) Redo the analysis in two dimensions.
...
released in a sneeze. This is causing a lot of controversy at the moment!
