...
droplet size.
Consult the literature on droplet size distribution and comment.

(c) (*For the author.*) Redo the analysis in two dimensions.
...
In Part II, we'll examine the effects of turbulence and Brownian
motion on the spray of droplets.
