...
You can actually explicitly calculate the integral for $T$ using the residue calculus from complex analysis. You directly get
...
for the mysterious term $a$ in brackets, without knowing anything about the geometry of ellipses.
