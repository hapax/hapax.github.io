...
**October 23, 2020.**  *According to physics folklore,
  ...
  Mandelstam-Tamm and Robertson-Schrödinger uncertainty relations, and
  interpreting virtual particles as fluctuations in expected particle number.*
...
In fact, these mediating $j$ particles may not even appear in the
initial and final state --- they pop into and out of existence, as it
were --- but modify do appear in the expectation $\langle
[N_i, I]\rangle$.
I leave checking this as an exercise for the interested reader! Or a
future paper.
