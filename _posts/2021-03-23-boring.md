...
**March 23, 2021.** *I turn the old joke about interesting numbers into a
  ...
  that there is no explicit well-ordering of the reals. Using the
  axiom of choice, however, I show they are all relatively interesting.*
...
post, and also for proposing an elegant mapping similar to unicoding.
