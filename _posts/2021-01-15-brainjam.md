...
Here, I want to compare brainjam to the doctrine of eternal recurrence, that time is cyclic and we are doomed to repeat ourselves.
...
In many cases, time is allowed to change radically between cycles (or
at least vary on themes),
but *recurrence* is the idea that the cycle must strictly repeat itself.
...
But what does being "free to choose" really mean?
<!-- If I have free will, then after choosing $A$, it is the case that I
"could have" chosen $B$. -->
There seem to be two reasonable interpretations: if things were different, I could have chosen
...
of the day,-->
I don't think this is what people are really talking
...
laws of physics must be indeterminate, so the state of the world now does
...
random, but rather, to play a role with respect to a much bigger
ensemble of decisions: the ones (call them $A_i$) that make up my life.
...
building", and as James Joyce said, mistakes sometimes become "portals of discovery".
<!-- teach us important lessons, or "create character". -->
To act with creative self-regard and "procreative
will" is to make errors, deliberate, and explore, and for those things
to change you in the process.
...
recurrence. -->
Both brainjam and eternal recurrence give a heuristic for optimising
...
moment of experience itself.

According to brainjam, each point in time
...
curbs their doomscrolling probably has long-term benefits as well
[<sup><a id="fnr.3" name="fnr.3" class="footref" href="#fn.3">3</a></sup>].
So, like eternal recurrence, even if brainjam is wrong, it may be
right anyway.
