...
$d$-dimensional foam.
 *Hint*. You will need to extend Plateau's laws in the same way
...
<span style="padding-left: 20px; display:block">
*Bonus 3.* Using similar reasoning to the previous section, we can
show that most bubbles in a three-dimensional foam have four faces.
...
Why is this consistent with the result about cross-sections of the
foam in part (c) above?
</span>
