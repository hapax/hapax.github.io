...
Technically, we haven't eliminated the possibility that vertices could
meet at an edge rather than a face.
But similar arguments show that, apart from the cube, the doesn't work either.

<span style="padding-left: 20px; display:block">
(g) Could an infinite foam be described by the cubic tessellation?
...
There are $26$ of these altogether. Rather than figure out ourselves
which ones tessellate --- a more laborious task than the Platonic
solids --- we will skip straight to the answer.
It turns out that only two can fill space: the
...
after Escher's marvellous lithograph
...
<span style="padding-left: 20px; display:block">
(d) Only one of these tessellations is consistent with Exercise 20, and can therefore
describe a foam.
