...
The solid vertex angles for the Platonic solids
[can be shown to be](https://en.wikipedia.org/wiki/Platonic_solid#Angles)
...
<span style="padding-left: 20px; display:block">
(f) Using a calculator or symbolic algebra package, show that none of
the angles above has this property.
</span>

Thus, the only Platonic solid which can tessellate is the cube.
We have already shown this does not work, so we must look elsewhere
for bubbles!
...
*Exercise 23.* We need to look beyond Platonic solids, and the next
simplest set of shapes are the
...
(Weaire discusses some of the experimental difficulties of arriving
at the Weaire-Phelan structure, rather than Kelvin's,
[here](https://www.tandfonline.com/doi/pdf/10.1080/09500830701697498).)
