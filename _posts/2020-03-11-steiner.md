...
In the last section, we were able to hack two-dimensional foams and
turn them into computers by adding screws as fixed points.
...
Another sort of constraint

---

*Exercise 17.* Using similar reasoning to <a href="#sec-4-1">our earlier
