...
(1801-1883) who arrived at them by assiduously experimenting with soap
bubbles!
Plateau's laws are connected to some deep mathematical problems, and
although being posed in the 19th century, they weren't proved until 1976!
...
Here are a few additional problems for the tenacious.

---

<span style="padding-left: 20px; display:block">
*Bonus 1.* Using similar reasoning to the previous section, show that
most bubbles in a three-dimensional foam have four sides.
You will need the three-dimensional version of Euler's formula,
</span>
...
<span style="padding-left: 20px; display:block">
where $C$ is the number of bubble cells, including an "external" cell.
</span>

<span style="padding-left: 20px; display:block">
*Bonus 2.* Find applications for minimal surfaces, and hence a 3d soap
bubble computer.
...
<span style="padding-left: 20px; display:block">
*Bonus 3.* By analogy, guess Plateau's laws for a $d$-dimensional
foam.
