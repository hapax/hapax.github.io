...
This does *not* mean that bubble walls are spherical; they can
also be "saddle-shaped".
...
There are $26$ of these altogether, and it takes much more work to
figure out which ones can tessellate.
Rather than do that ourselves, this time we will skip straight to the answer.
It turns out that two of them can be spammed to fill space: the
