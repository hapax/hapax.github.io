...
As a warm-up, let's start with the plane, which can be tiled in three
ways by regular polygons: squares, triangles, and hexagons.
Let's see why these are are the only possibilities.
