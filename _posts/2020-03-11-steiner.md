...
We will end this post by exploring their *three-dimensional* counterparts.
...
Instead of fixing a boundary, we can also fix the *volume* of a
bubble, i.e. that it enclose a given volume of air.
...
The Kelvin structure is a beautiful tiling of space, named after [Lord Kelvin](https://en.wikipedia.org/wiki/William_Thomson,_1st_Baron_Kelvin)
(1824-1907).
Kelvin conjectured it was the minimal area way to separate
an infinite number of cells of equal volume, basically a three-dimensional
...
carefully designed soap bubble experiments reproduce the Weaire-Phelan
structure.
Once again, we can physical computers to do our work for us.
