...
two-dimensional.
See Exercise 17 to learn mroe about the behaviour of three-dimensional foams.
...
1. The faces in a soap film are smooth.
...
<span style="padding-left: 20px; display:block">
(c) Explain why the result $D_\text{hex} = 6 + E_b$ given <a
href="#sec-4-1">above</a> holds despite (b).
</span>

The first three laws do not tell what happens when Plateau borders
meet.
To motivate Plateau's final law, we revisit the 
