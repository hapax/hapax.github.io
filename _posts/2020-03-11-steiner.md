...
for the cross-section $A$ despite (b).
</span>
...
<span style="padding-left: 20px; display:block">
(d) Given Plateau's first law, explain why (in the cross-section $A$)
at least three edges meet at a point.
</span>

<span style="padding-left: 20px; display:block">
(d) Show that if three edges meet at a point, the most symmetric
arrangement separates them by $120^\circ$.
</span>
