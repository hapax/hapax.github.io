...
The *Kelvin structure* is a space-filling tessellation made from
...
<a href="#sec-4-1">Earlier</a>, we could pin down the average
number of sides of a face, but here, we can only relate the average number of edges and faces of a bubble.
This is not a weakness of our method; there are just more
possibilities in three dimensions.
