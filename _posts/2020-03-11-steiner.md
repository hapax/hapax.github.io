...
**March 11, 2020.** *A lengthy but self-contained introduction to minimal
  ...
  geometric features, the topology of networks, and finally, what
  minimal networks can tell us about soap bubbles and vice versa.*
...
Of course, in real life bubbles are three-dimensional, not
two-dimensional.
See <a href="#sec-4-3">the bonus section</a> to learn about the
behaviour of three-dimensional foams.
...
*three-dimensional* counterparts, the foams we encounter in real life.
A two-dimensional form is a locally minimal network.
In three dimensions, we instead have *locally minimal networks*.
...
This is indeed Plateau's fourth law: Plateau borders meet four at a
vertex, separated by the (tetrahedral) angle $\theta_4 \approx 109.5^\circ$.
Here are double bonus problems for the tenacious.

---

*Bonus 1.* Find an application for minimal surfaces, and hence a 3d soap
bubble computer.
Instead of fixed points, you will have a fixed *boundary*, e.g. a
wire. Build such a computer and use it to solve a problem!

<p align="center">
  ⁂
  </p>

*Bonus 2.* Make a conjecture for Plateau's laws in a
$d$-dimensional foam.
 *Hint*. Extend Plateau's laws in the same way
 Plateau's laws extend the $120^\circ$ rule.

<p align="center">
  ⁂
  </p>

*Bonus 3.* Using similar reasoning to <a href="#sec-4-1">our earlier
...
<span style="padding-left: 20px; display:block">
Conclude that, unlike a two-dimensional foam, the average number
