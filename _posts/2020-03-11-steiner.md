...
version of the hexagonal lattice, and hence what four-dimensional bees would
store their honey in!
<a href="#sec-4-1">Earlier</a>, we were able to pin down the average
number of sides of a face, but here, we were only able to relate the average number of edges and faces of a bubble.
