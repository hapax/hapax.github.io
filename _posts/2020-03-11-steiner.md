...
used.
In fact, Darwin discusses the hive-making instinct in his
...
cells of equal size.
It turns out to be extremely hard to prove, since you need to somehow
check all possible irregular tilings as well, but in 1999, it became
the honeycomb *theorem* due to the work of
[Thomas Hales](https://en.wikipedia.org/wiki/Thomas_Callister_Hales).
In fact, this was related to the proof Hales is most famous for:  for his work on the related problem of sphere packing.
