...
the same length.
Draw lines (blue) from the outer corners of these attached equilateral
triangles to the opposite corner of our original triangle.
Our goal is to show that the intersection of blue lines is the
Fermat-Torricell point, making angles of $120^\circ$.
