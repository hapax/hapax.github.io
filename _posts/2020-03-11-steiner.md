...
Murphy's law applies to mathematics as well as life: whatever can go
wrong, will go wrong.
In 1993, mathematicians realised that something called the
[Weaire-Phelan structure](https://en.wikipedia.org/wiki/Weaire%E2%80%93Phelan_structure),
made from alternating polyhedra, is a more efficient way to segregate
cells of equal volume than the Kelvin structure.
...
deeply related and deserve our careful attention.
