...
"Constant mean curvature" is the property that any (straight)
cross-section of the surface looks like an arc of some circle.

Now, consider a cross-section of a three-dimensional foam.
We'll assume that we choose our cross-section is chosen so that it
slices through any faces and Plateau borders, i.e. a face in the
cross-section becomes an edge, and a Plateau border a point.

<span style="padding-left: 20px; display:block">
(a) Show that lines (faces) in the cross-section meet at angles of $120^\circ$.
</span>
