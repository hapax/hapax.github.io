...
*Edit: Section added April 8, 2020.*
...
<span style="padding-left: 20px; display:block">
*Bonus 1.* Using similar reasoning to the previous section, we can
...
*Bonus 2.* Find an application for minimal surfaces, and hence a 3d soap
bubble computer.
...
*Bonus 3.* By analogy, make a conjecture for Plateau's laws in a
$d$-dimensional foam.
