...
<span style="padding-left: 20px; display:block">
(a) Prove that internal angle of a regular $d$-gon (in radians) is
</span>
...
Now we upgrade to three dimensions.
In this case, there are only five regular polyhedra:
cube,
tetrahedron, octahedron, dodecahedron and icosahedron.
(This classification follows from Euler's theorem, but that's a story
for another day.)
