...
*Exercise 17.* Consider two bubbles of fixed volume $V$.
	...
	(Mathematicians proved this configuration was globally
	minimal in 2002.)
...
href="#sec-4-1">earlier hexagonality argument</a>, we can show that
faces of three-dimensional typically have *less* than $6$ sides.
We will relate this to the question of minimal surfaces enclosing an
infinite number of equally sized cells.
...
(1824-1907) conjectured that this tessellation was the most efficient way to separate
an infinite number of cells of equal volume, like a three-dimensional
version of the hexagonal lattice, and what four-dimensional bees would
store their honey in!
<a href="#sec-4-1">Earlier</a>, we were able to pin down the average
number of sides of a face.
Here, we were only able to relate the average number of edges and faces of a bubble.
This is not a weakness of our method; there are simply more
