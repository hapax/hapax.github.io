...
In real foams, such as the image below, bubble walls are curved rather
than straight.

<figure>
    <div style="text-align:center"><img src
    ="/images/posts/foam.jpg" width="65%"/>
		    <figcaption><i>A real two-dimensional foam. Klaus-Dieter
    Keller, Wikimedia Commons.</i></figcaption>
	</div>
	</figure>

But as we zoom in on a junction, we only care about the part of the
walls near the intersection.
Zoom in enough, and these walls look approximately straight!
Our minimisation argument will still apply, showing that curved walls
intersect three at a time, at angles of $120^\circ$.
The foam in the image above exhibits this property, and as a result,
it almost entirely consists of hexagonal cells.
