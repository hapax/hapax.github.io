...
**March 11, 2020.** *What do railway lines, honeycomb, and soap
 ...
 tutorial on the geometry and topology of minimal networks. Edit,
  April 8: Now with extra goodness on Plateau's laws and three-dimensional foams!*
...
<span style="padding-left: 20px; display:block">
(f) Using a symbolic algebra package, show that no Platonic solids
...
uses two different cells of equal volume, $C_1$ and $C_2$:
 - $C_1$ is an irregular dodecahedron, with twelve hexagonal faces; and
 - $C_2$ is a "tetrakaidecahedron" of two hexagonal and twelve pentagonal faces.

What ratio between $C_1$ and $C_2$ is needed for consistency with Exercise 20(d) and (e)?
...
it can be observed in naturally occurring crystals.
