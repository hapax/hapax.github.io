...
<span style="padding-left: 20px; display:block">
(e) Show that the most symmetric arrangement of three edges at a point separates them by $120^\circ$.
</span>
...
symmetrically.
The principles lead directly to Plateau's fourth law, for vertics in
a three-dimensional foam (and *not* in the cross-section $A$).

<span style="padding-left: 20px; display:block">
(f) Given Plateau's first law, explain why at least four Plateau
borders meet at a vertex.
</span>

<span style="padding-left: 20px; display:block">
(f) Show that the most symmetric arrangement of three edges at a point separates them by $120^\circ$.
</span>
