...
two-dimensional.
See Exercise 17 to learn about the behaviour of three-dimensional foams.
...
*Exercise 17 (Plateau's laws).* We've described the rules obeyed by
two-dimensional foams.
What about their *three-dimensional* counterparts?
These are (locally) minimal surfaces instead of (locally) minimal
networks, and the rules they obey are called *Plateau's laws*, after the Belgian
mathematician [Joseph Plateau](https://en.wikipedia.org/wiki/Joseph_Plateau)
(1801-1883).
He did not prove his laws, but rather, arrived at them by
...
<span style="padding-left: 20px; display:block">
*Bonus 2.* By analogy, guess Plateau's laws for a $d$-dimensional
foam.
 *Hint*. You will need to extend Plateau's laws in the same way
 Plateau's laws extend the hub and spoke rule.
</span>
