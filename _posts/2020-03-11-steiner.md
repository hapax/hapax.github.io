...
<span style="padding-left: 20px; display:block">
(d) Show that only the hexagonal lattice is locally minimal, as
...
<span style="padding-left: 20px; display:block">
(e) Argue that, for a Platonic solid to tessellate "vertex only", it
must have vertex angle $\Omega = 4\pi/n$ for some integer $n$.
</span>

<span style="padding-left: 20px; display:block">
(f) Using a calculator or symbolic algebra package, show that only
...
<span style="padding-left: 20px; display:block">
(g) Suppose we tessellate space using a cell with $f$ faces, each with
$e$ edges.
...
<span style="padding-left: 20px; display:block">
(h) Showing using Exercise 20 or Plateau's laws directly that an
