...
<figure>
    <div style="text-align:center"><img src
    ="/images/posts/steiner29.png" width="90%"/>
...
<span style="padding-left: 20px; display:block">
(a) Show that $\angle baf = \angle bcf$. *Hint*. Use
symmetry of the figure along the blue line starting at $b$.
</span>
...
Using the inscribed angle theorem once more, show that $\angle cfb = 120^\circ$.
</span>
