...
(1607--1665) was the first to ask about these minimal networks on the
triangle, though he phrased the problem as follows:
...
The problem was solved by Galileo's student
...
Fermat, Torricelli, and Steiner were only concerned about geometry.
But 200 years later, the great German mathematician
[Carl Friedrich Gauss](https://en.wikipedia.org/wiki/Carl_Friedrich_Gauss)
(1777 -- 1855) considered the problem of designing a minimal rail
network between four German cities.
...
1934, when Jarnik and Kossler revisited the problem.
It was later popularised in Courant and Robbins' classic book, *What
is mathematics?*
