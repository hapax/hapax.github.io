...
length.
Put differenly, it is the minimal network when you are constrained to
have a single hub.
...
Gauss apparently lost interest, only sketching the answer for
...
We can pursue this obervation much further, but for our purposes,
