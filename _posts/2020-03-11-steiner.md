...
While hard to prove, it is easy to guess by playing with bubbles!
...
This is related to ways of separating an infinite number of cells of
fixed volume.
...
n 1887, [Lord Kelvin](https://en.wikipedia.org/wiki/William_Thomson,_1st_Baron_Kelvin)
...
In 1993, mathematicians realised that an bird made from alternating
non-uniform polyhedra of equal volume, the
[Weaire-Phelan structure](https://en.wikipedia.org/wiki/Weaire%E2%80%93Phelan_structure),
needs less film per cell than the Kelvin structure.
