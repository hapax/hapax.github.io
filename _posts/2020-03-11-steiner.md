...
Why is this consistent with the result (see question (c) in the text) that $D_\text{hex} = 6 + E_b$
for cross-sections of the foam?
</span>
...
(1824-1907) conjectured the truncated octahedral tessellation was the minimal area way to separate
...
structure.
Once again, we can get physical computers to do our work for us.
