...
We will do this in the form of an extended, optional exercise.
...
<span style="padding-left: 20px; display:block">
(b) Show that only the cube can tessellate space. *Hint.* Only the
cube has a
[vertex solid angle](https://en.wikipedia.org/wiki/Platonic_solid#Angles) of
the form $2\pi/n$ for some $n$.
</span>
...
Only one of these tessellations is consistent with Exercise 18, and can therefore
describe a foam.
