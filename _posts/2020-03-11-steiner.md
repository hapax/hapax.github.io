...
tessellation by [cubes](https://en.wikipedia.org/wiki/Cubic_honeycomb).
</span>
...
This seems reasonable: of the
[28 known space-filling tessellations](https://en.wikipedia.org/wiki/Convex_uniform_honeycomb)
with regular polyhedra, the only two with equal volume cells are the
cubic and Kelvin structure, and we ruled cubes out.
(You can similarly rule of hexagonal prisms.)
