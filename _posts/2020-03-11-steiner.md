...
The sphere is not only locally minimal, but the
...
But <a href="#sec-4-1">above</a>, we were able to pin down the average
number of sides of a face.
Here, we have the weaker result that we can relate the average number
of edges and faces of a bubble.
...
you can reproduce this structure from soap film experiments!
